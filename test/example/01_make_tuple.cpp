...
+----------+
    |
+-----------------------+
|v_wrap<int, empty_base>|
+-----------------------+
    |
+---------------------------------------------+
|v_wrap<const char *, v_wrap<int, empty_base>>|
+---------------------------------------------+
    |
+-------------------------------------------------------------+
|v_wrap<double, v_wrap<const char *, v_wrap<int, empty_base>>>|
+-------------------------------------------------------------+
*/
...
/*
                                                      +-----------+        +----------+
                                                      |holder<int>|        |empty_base|
                                                      +-----------+        +----------+
                                                            |                   |
                        +--------------------+        +-------------------------------+
                        |holder<const char *>|        |h_wrap<holder<int>, empty_base>|
                        +--------------------+        +-------------------------------+
                                    |                                   |
+--------------+        +-------------------------------------------------------------+
|holder<double>|        |h_wrap<holder<const char *>, h_wrap<holder<int>, empty_base>>|
+--------------+        +-------------------------------------------------------------+
        |                                           |
+-------------------------------------------------------------------------------------+
|h_wrap<holder<double>, h_wrap<holder<const char *>, h_wrap<holder<int>, empty_base>>>|
+-------------------------------------------------------------------------------------+
*/
